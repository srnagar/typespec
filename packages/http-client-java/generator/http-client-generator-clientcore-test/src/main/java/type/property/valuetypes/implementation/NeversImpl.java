...
public final class NeversImpl {
    ...
    NeversImpl(ValueTypesClientImpl client) {
        this.service = NeversService.getNewInstance(client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface NeversService {
        ...
        Response<Object> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
    ...
    public Response<Object> getWithResponse(RequestContext requestContext) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> putWithResponse(Object body, RequestContext requestContext) {
