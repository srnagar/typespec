...
public class ClientCorePrimitiveMapper extends PrimitiveMapper {
    private static final PrimitiveMapper INSTANCE = new ClientCorePrimitiveMapper();
    protected Map<PrimitiveSchema, IType> parsed = new HashMap<>();

    protected ClientCorePrimitiveMapper() {
    }
...
//                break;
            ...
            case INTEGER:
                ...
                if ("string".equals(intSchema.getEncode())) {
                    ...
                    return (intSchema.getPrecision() == 64) ? PrimitiveType.LONG : PrimitiveType.INT;
                }
            case STRING:
                return ClassType.STRING;
            ...
            case URI:
                return isLowLevelClient || urlAsString ? ClassType.STRING : ClassType.URL;
            ...
            case CREDENTIAL:
                return ClassType.TOKEN_CREDENTIAL;
