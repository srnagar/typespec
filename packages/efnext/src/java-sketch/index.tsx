import { EmitOutput, Scope, SourceDirectory, emit } from "#typespec/emitter/core";
import { javaNamePolicy } from "#typespec/emitter/java";
...
export async function $onEmit(context: EmitContext) {
  ...
  console.log("Java emitter running");

  // queryApp walks the type graph and assembles the AppFolder structure.
  const rootFolder = queryApp(context);
  await emit(
    context,
    <EmitOutput namePolicy={javaNamePolicy}>
      <SourceDirectory path="com/azure/">
        <Scope name="com/azure">
